...
- [ ] Eww Widgets -> It is such an amazing thing
- [x] Cava -> WallpaperEngine for Linux via hyprwinwrap xd
- [ ] Waypaper -> Just adding post-scripts color stuff
- [ ] Vesktop/BetterDiscord -> Create your own script, f&#k
- [ ] Firefox -> FirefoxCSS is quite the rabbit-hole
